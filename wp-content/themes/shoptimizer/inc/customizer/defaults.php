...
if ( ! function_exists( 'shoptimizer_get_option_defaults' ) ) {
	...
	function shoptimizer_get_option_defaults() {
		$defaults = array(
			...
			'shoptimizer_cross_sells_carousel'									=> false,
			'shoptimizer_cross_sells_carousel_heading'      					=> 'Pairs well with',
			...
			'shoptimizer_display_cross_sells'									=> true,
			...
			// Accessibility.
			'shoptimizer_general_accessibility_reduced_motion'					=> true,
